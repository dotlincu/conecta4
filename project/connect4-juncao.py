...
def minimax(board, depth, alpha, beta, maximizing_player):
    ...
    if maximizing_player:
        ...
        for col in valid_locations:
            ...
            new_score, new_nodes = minimax(temp_board, depth - 1, alpha, beta, False)[1:]  # Ignore the first element (column)
            if new_score > value:
                value = new_score
                column = col
        ...
        for col in valid_locations:
            ...
            new_score, new_nodes = minimax(temp_board, depth - 1, alpha, beta, True)[1:]  # Ignore the first element (column)
            if new_score < value:
                value = new_score
                column = col
            total_nodes += new_nodes
